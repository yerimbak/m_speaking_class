...
gulp.task('fileMove', () => {
    return new Promise(resolve => {
        ...
        gulp
        .src(dir.src.sass + '**/*.css')
        .pipe((gulp.dest(dir.dist.css)));

        gulp
        .src(dir.src.html + '**/*.json')
        .pipe((gulp.dest(dir.dist.html)));

        gulp
        .src(SRC + 'sitemap.html')
        .pipe((gulp.dest(DIST)));
...
gulp.task(
    'build',
    gulp.series('fileClean', 'fileInclude', 'index', 'fileMove', 'images', 'sass','removeMap')
);
